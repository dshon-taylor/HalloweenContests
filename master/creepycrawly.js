...
export function introduceCreepyCrawly() {
    var BugDispatch = {
        ...
        options: {
            ...
            sizedivider: 10, // the higher the number, the smaller the bug.
            canFly: true,
            canDie: true,
            numDeathTypes: 3,
            monitorMouseMovement: false,
            eventDistanceToBug: 40,
            minTimeBetweenMultipy: 1500,
    ...
    var Bug = {
        ...
        initialize: function(transform, options) {
            ...
            this.zoom = this.random(this.options.zoom, 10) / this.options.sizedivider;
    ...
    const bugControllerInstance = new BugController({});

    // default spiders:
    const spiderControllerInstance = new SpiderController({});

    const insectInstances = [bugControllerInstance, spiderControllerInstance];
